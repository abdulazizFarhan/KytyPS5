...
constexpr uint32_t PA_SC_WINDOW_SCISSOR_TL_TL_X_SHIFT                  = 0;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_TL_TL_X_MASK                   = 0x7FFF;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_TL_TL_Y_SHIFT                  = 16;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_TL_TL_Y_MASK                   = 0x7FFF;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_TL_WINDOW_OFFSET_DISABLE_SHIFT = 31;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_TL_WINDOW_OFFSET_DISABLE_MASK  = 0x1;

constexpr uint32_t PA_SC_WINDOW_SCISSOR_BR            = 0x82;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_BR_BR_X_SHIFT = 0;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_BR_BR_X_MASK  = 0x7FFF;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_BR_BR_Y_SHIFT = 16;
constexpr uint32_t PA_SC_WINDOW_SCISSOR_BR_BR_Y_MASK  = 0x7FFF;
...
constexpr uint32_t PA_SC_FSR_ENABLE             = 0xF0;
constexpr uint32_t FSR_RECURSIONS0              = 0xF1;
constexpr uint32_t FSR_RECURSIONS1              = 0xF2;
...
constexpr uint32_t DB_SHADER_CONTROL_MASK_EXPORT_ENABLE_SHIFT    = 8;
constexpr uint32_t DB_SHADER_CONTROL_MASK_EXPORT_ENABLE_MASK     = 0x1;
constexpr uint32_t DB_SHADER_CONTROL_DUAL_EXPORT_ENABLE_SHIFT    = 9;
constexpr uint32_t DB_SHADER_CONTROL_DUAL_EXPORT_ENABLE_MASK     = 0x1;
constexpr uint32_t DB_SHADER_CONTROL_EXEC_ON_NOOP_SHIFT          = 10;
constexpr uint32_t DB_SHADER_CONTROL_EXEC_ON_NOOP_MASK           = 0x1;
constexpr uint32_t DB_SHADER_CONTROL_ALPHA_TO_MASK_DISABLE_SHIFT = 11;
constexpr uint32_t DB_SHADER_CONTROL_ALPHA_TO_MASK_DISABLE_MASK  = 0x1;
...
constexpr uint32_t PA_SU_POLY_OFFSET_DB_FMT_CNTL_NEG_NUM_DB_BITS_SHIFT = 0;
constexpr uint32_t PA_SU_POLY_OFFSET_DB_FMT_CNTL_NEG_NUM_DB_BITS_MASK  = 0xFF;
constexpr uint32_t PA_SU_POLY_OFFSET_DB_FMT_CNTL_DB_IS_FLOAT_FMT_SHIFT = 8;
constexpr uint32_t PA_SU_POLY_OFFSET_DB_FMT_CNTL_DB_IS_FLOAT_FMT_MASK  = 0x1;
...
constexpr uint32_t SPI_SHADER_TBA_LO_PS     = 0x0;
constexpr uint32_t SPI_SHADER_PGM_RSRC4_PS  = 0x1;
constexpr uint32_t SPI_SHADER_TMA_LO_PS     = 0x2;
constexpr uint32_t SPI_SHADER_TMA_HI_PS     = 0x3;
...
constexpr uint32_t SPI_SHADER_REQ_CTRL_PS     = 0x30;
constexpr uint32_t SPI_SHADER_USER_ACCUM_PS_0 = 0x32;
constexpr uint32_t SPI_SHADER_USER_ACCUM_PS_3 = 0x35;
...
constexpr uint32_t SPI_SHADER_USER_DATA_ES_0       = 0xCC;
constexpr uint32_t SPI_SHADER_USER_DATA_ES_15      = 0xDB;
constexpr uint32_t SPI_SHADER_USER_DATA_ES_31      = 0xEB;
...
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_VGPRS_SHIFT            = 0;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_VGPRS_MASK             = 0x3F;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_PRIORITY_SHIFT         = 10;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_PRIORITY_MASK          = 0x3;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_FLOAT_MODE_SHIFT       = 12;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_FLOAT_MODE_MASK        = 0xFF;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_DX10_CLAMP_SHIFT       = 21;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_DX10_CLAMP_MASK        = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_DEBUG_MODE_SHIFT       = 22;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_DEBUG_MODE_MASK        = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_IEEE_MODE_SHIFT        = 23;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_IEEE_MODE_MASK         = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_FWD_PROGRESS_SHIFT     = 25;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_FWD_PROGRESS_MASK      = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_WGP_MODE_SHIFT         = 26;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_WGP_MODE_MASK          = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_LS_VGPR_COMP_CNT_SHIFT = 28;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_LS_VGPR_COMP_CNT_MASK  = 0x3;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_FP16_OVFL_SHIFT        = 30;
constexpr uint32_t SPI_SHADER_PGM_RSRC1_HS_FP16_OVFL_MASK         = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_SCRATCH_EN_SHIFT       = 0;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_SCRATCH_EN_MASK        = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_USER_SGPR_SHIFT        = 1;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_USER_SGPR_MASK         = 0x1F;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_LDS_SIZE_SHIFT         = 18;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_LDS_SIZE_MASK          = 0x1FF;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_USER_SGPR_MSB_SHIFT    = 27;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_USER_SGPR_MSB_MASK     = 0x1;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_SHARED_VGPR_CNT_SHIFT  = 28;
constexpr uint32_t SPI_SHADER_PGM_RSRC2_HS_SHARED_VGPR_CNT_MASK   = 0xF;
constexpr uint32_t SPI_SHADER_USER_DATA_HS_0       = 0x10C;
constexpr uint32_t SPI_SHADER_USER_DATA_HS_15      = 0x11B;
constexpr uint32_t SPI_SHADER_USER_DATA_HS_31      = 0x12B;
constexpr uint32_t SPI_SHADER_REQ_CTRL_LSHS        = 0x130;
...
constexpr uint32_t COMPUTE_TBA_LO                  = 0x20E;
constexpr uint32_t COMPUTE_TBA_HI                  = 0x20F;
constexpr uint32_t COMPUTE_TMA_LO                  = 0x210;
constexpr uint32_t COMPUTE_TMA_HI                  = 0x211;
