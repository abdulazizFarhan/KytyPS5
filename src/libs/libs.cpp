...
LIB_DEFINE(InitContentExport_1) {
	...
	LIB_FUNC("FCygF4Ec4so", ContentExport::ContentExportInit2);  // GTA V ContentExport_v1

	LIB_FUNC("mbakKLPSO4o", ContentExport::ContentExportInit2);

	LIB_FUNC("OWCJUmrWH1g", ContentExport::ContentExportInit2);

	LIB_FUNC("tb3cZTCl8Ps", ContentExport::ContentExportInit2);

	LIB_FUNC("+KDWny9Y-6k", ContentExport::ContentExportInit2);
...
LIB_DEFINE(InitContentSearch_1) {
	...
	LIB_FUNC("TEW3IKxYfXc", ContentSearch::ContentSearchInit);  // GTA V ContentSearch_v1

	LIB_FUNC("G13HF1z-e4o", ContentSearch::ContentSearchInit);

	LIB_FUNC("EbNufIY0Zvc", ContentSearch::ContentSearchInit);

	LIB_FUNC("ruNe-FgCzO8", ContentSearch::ContentSearchInit);

	LIB_FUNC("-YbpaF0XS-I", ContentSearch::ContentSearchInit);

	LIB_FUNC("1xSZodB2geA", ContentSearch::ContentSearchInit);
...
LIB_DEFINE(InitContentDelete_1) {
	...
	LIB_FUNC("qC3QW+AltHs", ContentDelete::ContentDeleteInitialize);  // GTA V ContentDelete_v1

	LIB_FUNC("5XLSih32qHA", ContentDelete::ContentDeleteInitialize);
